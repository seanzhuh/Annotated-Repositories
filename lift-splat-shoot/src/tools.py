...
def img_transform(img, post_rot, post_tran,
    ...
    # don't change resolution, still fW x fH
    # but with black padding pixels and possibly lose some part, https://blog.csdn.net/Tornado_Liao/article/details/109508848
    img = img.rotate(rotate)

    # post-homography transformation
    # https://zhuanlan.zhihu.com/p/608931944, very clear
    post_rot *= resize
