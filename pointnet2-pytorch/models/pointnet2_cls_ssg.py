...
class get_model(nn.Module):
    def __init__(self, num_class, normal_channel=True):
        ...
        # npoint is the number of centroids, nsample is the maximum number of local points inside the radius
    ...
    def forward(self, xyz):
        ...
        if self.normal_channel:
            ...
            norm = None
        # the first sa1 layer returns Bx512x3 sampled centroids from input point cloud
        # and the l1_points is Bx128x512 the pointnet features for each centroid
